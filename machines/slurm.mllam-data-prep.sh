...
#SBATCH --output=/dcai/users/${USER}/git-repos/mllam-exps/logs/mllam-data-prep.%j.log
#SBATCH --error=/dcai/users/${USER}/git-repos/mllam-exps/logs/mllam-data-prep.%j.log
